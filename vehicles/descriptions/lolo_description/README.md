...
LoLo's scientists should always run the 'lolo_description.launch' to set up the TF frames for
all the sensors.
...
* `/lolo/thrusters/0/input` - starboard thruster
...
* `/lolo/thrusters/0/output` - starboard thruster
