...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/models/FC30/continuous_model', glob('models/FC30/continuous_model/**')),
        ('share/' + package_name + '/models/FC30/discrete_model', glob('models/FC30/discrete_model/**')),
    ],
