...
def generate_launch_description():
    ...
    max_steering_output = LaunchConfiguration('max_steering_output')  #, 179.0) 
    max_speed = LaunchConfiguration('max_speed')    #, 6) #m/s ~12 knots
    closed_loop_control = LaunchConfiguration('closed_loop_control')  #, False)
    ...
    open_loop_gain = LaunchConfiguration('open_loop_gain')   #, 3.0)
    ...
    max_steering_output_arg = DeclareLaunchArgument('max_steering_output', default_value='179.0')
    max_speed_arg = DeclareLaunchArgument('max_speed', default_value='6')
    closed_loop_control_arg = DeclareLaunchArgument('closed_loop_control', default_value='false')
    ...
    open_loop_gain_arg = DeclareLaunchArgument('open_loop_gain', default_value='3.0')
