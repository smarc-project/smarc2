...
-  LOLO_ABORT :  'abort'
-  YAW_SETPOINT :  "ctrl/yaw_setpoint"
-  YAW_RATE_SETPOINT :  "ctrl/yawrate_setpoint"
-  YAW_ACTUATION :  "ctrl/yaw_actuation"
-  ROLL_SETPOINT :  "ctrl/roll_setpoint"
-  ROLL_RATE_SETPOINT :  "ctrl/rollrate_setpoint"
-  ROLL_ACTUATION :  "ctrl/roll_actuation"
-  PITCH_SETPOINT :  "ctrl/pitch_setpoint"
-  PITCH_RATE_SETPOINT :  "ctrl/pitchrate_setpoint"
-  PITCH_ACTUATION :  "ctrl/pitch_actuation"
-  DEPTH_SETPOINT :  "ctrl/depth_setpoint"
-  RPM_SETPOINT :  "ctrl/rpm_setpoint"
...
-  EXTENDED_BATTERY_1_TOPIC :  "extended/battery1"
-  EXTENDED_BATTERY_2_TOPIC :  "extended/battery2"
-  SATELITE_RECEIVED_TOPIC :  "communication/satelite_received"
-  USBL_RECEIVED_TOPIC :  "communication/usbl/received"
-  USBL_TRANSMIT_TOPIC :  "communication/usbl/transmit"
-  USBL_RECEIVED_CHR_TOPIC :  "communication/usbl/received/chr"
-  USBL_CUSTOM_CMD_TOPIC :  "communication/usbl/custom_command"
...
-  DO_RAW_REQUEST_TOPIC :  sensors/do/raw_request
...
-  MBES_WC_TOPIC :  sensors/mbes/watercolumn
-  MBES_IMAGE_TOPIC :  sensors/mbes/watercolumn/image
-  MBES_BATHY_TOPIC :  sensors/mbes/bathymetry
-  MBES_BATHY_POINTCLOUD_TOPIC :  sensors/mbes/bathymetry/points
-  USBL_CORRECTION_TOPIC :  "sensors/usbl/correction"
-  USBL_RELATIVE_TOPIC :  "sensors/usbl/relative_pose"
-  LEAK_TOPIC :  "sensor/leak"
...
-  GEOFENCE_CHECKER_SERVICE :  'mission/geofence_checker'
...
-  GOTO_GEOPOINT_ACTION :  '/mission/move_to'
...
-  VEHICLE_HEALTH_TOPIC :  'core/vehicle_health'
-  STD_LEAK_TOPIC :  'core/standard/leak'
-  STD_VBS_CMD_TOPIC :  'core/standard/vbs_cmd'
-  STD_LCG_CMD_TOPIC :  'core/standard/lcg_cmd'
-  STD_THRUSTER1_CMD_TOPIC :  'core/standard/thruster1_cmd'
-  STD_THRUSTER2_CMD_TOPIC :  'core/standard/thruster2_cmd'
-  STD_THRUST_VECTOR_YAW_CMD_TOPIC :  'core/standard/thrust_vector_yaw_cmd'
-  STD_THRUST_VECTOR_PITCH_CMD_TOPIC :  'core/standard/thrust_vector_pitch_cmd'
-  STD_VBS_FB_TOPIC :  'core/standard/vbs_fb'
-  STD_LCG_FB_TOPIC :  'core/standard/lcg_fb'
-  STD_THRUSTER1_FB_TOPIC :  'core/standard/thruster1_fb'
-  STD_THRUSTER2_FB_TOPIC :  'core/standard/thruster2_fb'
...
-  THRUST_VECTOR_YAW_CMD_TOPIC :  'core/thrust_vector_yaw_cmd'
-  THRUST_VECTOR_PITCH_CMD_TOPIC :  'core/thrust_vector_pitch_cmd'
-  DEPTH_TOPIC :  'core/depth20_pressure'
-  DVL_TOPIC :  'core/dvl'
-  DVL_RAW_TOPIC :  'core/dvl_raw_output'
...
-  STIM_CALIBRATION_SRV :  'core/IMU_calibration'
-  DVL_TOGGLE_SRV :  'core/toggle_dvl'
...
-  DEPTH :  'dr/depth' 
-  PITCH :  'core/imu' 
-  MOCAP_STATE :  'smarc/odom' 
-  DEPTH_SETPOINT :  'ctrl/depth_setpoint' 
-  PITCH_SETPOINT :  'ctrl/pitch_setpoint' 
-  WAYPOINT :  'ctrl/waypoint' 
-  TRAJ_MPC :  'ctrl/traj_mpc' 
-  MOCAP_HYDROPOINT :  'ctrl/mocap_hydropoint' 
...
-  BT_STATUS_TOPIC :  'smarc/bt_status' 
-  WARA_PS_HEARTBEAT_TOPIC :  'waraps/heartbeat'
-  WARA_PS_SENSOR_INFO_TOPIC :  'waraps/sensor_info'
-  WARA_PS_SENSOR_POSITION_TOPIC :  'waraps/sensor/position'
-  WARA_PS_SENSOR_HEADING_TOPIC :  'waraps/sensor/heading'
-  WARA_PS_SENSOR_COURSE_TOPIC :  'waraps/sensor/course'
-  WARA_PS_SENSOR_SPEED_TOPIC :  'waraps/sensor/speed'
-  WARA_PS_SENSOR_DEPTH_TOPIC :  'waraps/sensor/depth'
-  WARA_PS_SENSOR_ROLL_TOPIC :  'waraps/sensor/roll'
-  WARA_PS_SENSOR_PITCH_TOPIC :  'waraps/sensor/pitch'
-  WARA_PS_SENSOR_EXECUTING_TASKS_TOPIC :  'waraps/sensor/executing_tasks'
-  WARA_PS_SENSOR_BT_TOPIC :  'waraps/sensor/bt'
-  WARA_PS_DIRECT_EXECUTION_INFO_TOPIC :  'waraps/direct_execution_info'
-  WARA_PS_EXEC_RESPONSE_TOPIC :  'waraps/exec/response'
-  WARA_PS_EXEC_FEEDBACK_TOPIC :  'waraps/exec/feedback'
-  WARA_PS_EXEC_COMMAND_TOPIC :  'waraps/exec/command'
-  WARA_PS_TST_EXEC_INFO_TOPIC :  'waraps/tst_execution_info'
-  WARA_PS_TST_COMMAND_TOPIC :  'waraps/tst/command'
-  WARA_PS_TST_RESPONSE_TOPIC :  'waraps/tst/response'
-  WARA_PS_TST_FEEDBACK_TOPIC :  'waraps/tst/feedback'
-  WARA_PS_ABORT_TOPIC :  'waraps/abort'
-  WARA_PS_ACTION_SERVER_HB_TOPIC :  'waraps/action_server_heartbeat'
## Topics in file: [messages/dji_msgs/msg/Topics.msg](messages/dji_msgs/msg/Topics.msg)

-  MOVE_TO_SETPOINT_TOPIC :  'move_to_setpoint'
-  CONTROLLER_INPUT_TOPIC :  'joy'
-  CONTROLLER_VIBRATION_TOPIC :  'joy/set_feedback'
-  TTS_TOPIC :  'speak'

# Duplicates

-  'core/heartbeat': 
    - [ HEARTBEAT_TOPIC ](messages/sam_msgs/msg/Topics.msg)
    - [ HEARTBEAT_TOPIC ](messages/smarc_msgs/msg/Topics.msg)
...
-  'smarc/odom' : 
    - [ STATES ](messages/smarc_control_msgs/msg/Topics.msg)
    - [ MOCAP_STATE ](messages/smarc_control_msgs/msg/Topics.msg)
