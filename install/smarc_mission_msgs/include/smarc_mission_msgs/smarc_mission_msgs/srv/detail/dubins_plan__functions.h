...
#ifndef SMARC_MISSION_MSGS__SRV__DETAIL__DUBINS_PLAN__FUNCTIONS_H_
#define SMARC_MISSION_MSGS__SRV__DETAIL__DUBINS_PLAN__FUNCTIONS_H_
...
/// Initialize srv/DubinsPlan message.
/**
...
/// Finalize srv/DubinsPlan message.
/**
...
/// Create srv/DubinsPlan message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * smarc_mission_msgs__srv__DubinsPlan_Request__init().
...
/// Destroy srv/DubinsPlan message.
/**
 * It calls
 * smarc_mission_msgs__srv__DubinsPlan_Request__fini()
...
/// Check for srv/DubinsPlan message equality.
/**
...
/// Initialize array of srv/DubinsPlan messages.
/**
...
/// Finalize array of srv/DubinsPlan messages.
/**
 * It calls
 * smarc_mission_msgs__srv__DubinsPlan_Request__fini()
...
/// Create array of srv/DubinsPlan messages.
/**
 * It allocates the memory for the array and calls
 * smarc_mission_msgs__srv__DubinsPlan_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/DubinsPlan messages.
/**
 * It calls
 * smarc_mission_msgs__srv__DubinsPlan_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/DubinsPlan message array equality.
/**
...
/// Copy an array of srv/DubinsPlan messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * smarc_mission_msgs__srv__DubinsPlan_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_smarc_mission_msgs
...
/**
 * It calls
 * smarc_mission_msgs__srv__DubinsPlan_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_smarc_mission_msgs
...
/**
 * It allocates the memory for the array and calls
 * smarc_mission_msgs__srv__DubinsPlan_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_smarc_mission_msgs
...
/**
 * It calls
 * smarc_mission_msgs__srv__DubinsPlan_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SMARC_MISSION_MSGS__SRV__DETAIL__DUBINS_PLAN__FUNCTIONS_H_
