...
bool smarc_msgs__msg__thruster_rpm__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("smarc_msgs.msg._thruster_rpm.ThrusterRPM", full_classname_dest, 40) == 0);
  }
  smarc_msgs__msg__ThrusterRPM * ros_message = _ros_message;
  {  // rpm
...
{
  /* NOTE(esteve): Call constructor of ThrusterRPM */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("smarc_msgs.msg._thruster_rpm");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ThrusterRPM");
