...
bool smarc_msgs__msg__sm_task__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("smarc_msgs.msg._sm_task.SMTask", full_classname_dest, 30) == 0);
  }
  smarc_msgs__msg__SMTask * ros_message = _ros_message;
  {  // task_id
  ...
  {  // action_topic
    PyObject * field = PyObject_GetAttrString(_pymsg, "action_topic");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->action_topic, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // action_arguments
    PyObject * field = PyObject_GetAttrString(_pymsg, "action_arguments");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->action_arguments, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of SMTask */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("smarc_msgs.msg._sm_task");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SMTask");
  ...
  {  // action_topic
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->action_topic.data,
      strlen(ros_message->action_topic.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "action_topic", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // action_arguments
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->action_arguments.data,
      strlen(ros_message->action_arguments.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "action_arguments", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
