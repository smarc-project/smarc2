...
{
  new (message_memory) smarc_msgs::msg::StringPair(_init);
}

void StringPair_fini_function(void * message_memory)
{
  auto typed_message = static_cast<smarc_msgs::msg::StringPair *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StringPair_message_member_array[2] = {
  {
    ...
    offsetof(smarc_msgs::msg::StringPair, first),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(smarc_msgs::msg::StringPair, second),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StringPair_message_members = {
  ...
  2,  // number of fields
  sizeof(smarc_msgs::msg::StringPair),
...
{
  return &::smarc_msgs::msg::rosidl_typesupport_introspection_cpp::StringPair_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, smarc_msgs, msg, StringPair)() {
  return &::smarc_msgs::msg::rosidl_typesupport_introspection_cpp::StringPair_message_type_support_handle;
}
