...
smarc_msgs__msg__DVL__init(smarc_msgs__msg__DVL * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    smarc_msgs__msg__DVL__fini(msg);
    return false;
  }
  // velocity
  ...
  // altitude
  // beams
  if (!smarc_msgs__msg__DVLBeam__Sequence__init(&msg->beams, 0)) {
    smarc_msgs__msg__DVL__fini(msg);
    return false;
  }
  return true;
...
smarc_msgs__msg__DVL__fini(smarc_msgs__msg__DVL * msg)
{
  ...
  // altitude
  // beams
  smarc_msgs__msg__DVLBeam__Sequence__fini(&msg->beams);
}
...
smarc_msgs__msg__DVL__are_equal(const smarc_msgs__msg__DVL * lhs, const smarc_msgs__msg__DVL * rhs)
{
  ...
  // beams
  if (!smarc_msgs__msg__DVLBeam__Sequence__are_equal(
      &(lhs->beams), &(rhs->beams)))
  {
    return false;
  }
  ...
  smarc_msgs__msg__DVL * output)
{
  ...
  // beams
  if (!smarc_msgs__msg__DVLBeam__Sequence__copy(
...
smarc_msgs__msg__DVL__create()
{
  ...
  smarc_msgs__msg__DVL * msg = (smarc_msgs__msg__DVL *)allocator.allocate(sizeof(smarc_msgs__msg__DVL), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(smarc_msgs__msg__DVL));
  bool success = smarc_msgs__msg__DVL__init(msg);
  if (!success) {
...
smarc_msgs__msg__DVL__Sequence__init(smarc_msgs__msg__DVL__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smarc_msgs__msg__DVL * data = NULL;

  if (size) {
    data = (smarc_msgs__msg__DVL *)allocator.zero_allocate(size, sizeof(smarc_msgs__msg__DVL), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = smarc_msgs__msg__DVL__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        smarc_msgs__msg__DVL__fini(&data[i - 1]);
      }
...
smarc_msgs__msg__DVL__Sequence__fini(smarc_msgs__msg__DVL__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      smarc_msgs__msg__DVL__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smarc_msgs__msg__DVL__Sequence * array = (smarc_msgs__msg__DVL__Sequence *)allocator.allocate(sizeof(smarc_msgs__msg__DVL__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = smarc_msgs__msg__DVL__Sequence__init(array, size);
  if (!success) {
...
smarc_msgs__msg__DVL__Sequence__destroy(smarc_msgs__msg__DVL__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    smarc_msgs__msg__DVL__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
smarc_msgs__msg__DVL__Sequence__are_equal(const smarc_msgs__msg__DVL__Sequence * lhs, const smarc_msgs__msg__DVL__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!smarc_msgs__msg__DVL__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  smarc_msgs__msg__DVL__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(smarc_msgs__msg__DVL);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    smarc_msgs__msg__DVL * data =
      (smarc_msgs__msg__DVL *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!smarc_msgs__msg__DVL__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          smarc_msgs__msg__DVL__fini(&output->data[i]);
        }
        return false;
      }
    }
