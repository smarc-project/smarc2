...
#ifndef SMARC_MSGS__MSG__DETAIL__SENSOR_STATUS__TRAITS_HPP_
#define SMARC_MSGS__MSG__DETAIL__SENSOR_STATUS__TRAITS_HPP_
...
inline void to_yaml(
  const smarc_msgs::msg::SensorStatus & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const smarc_msgs::msg::SensorStatus & msg)
{
  return smarc_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<smarc_msgs::msg::SensorStatus>()
{
  return "smarc_msgs::msg::SensorStatus";
}

template<>
inline const char * name<smarc_msgs::msg::SensorStatus>()
{
  return "smarc_msgs/msg/SensorStatus";
}

template<>
struct has_fixed_size<smarc_msgs::msg::SensorStatus>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<smarc_msgs::msg::SensorStatus>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<smarc_msgs::msg::SensorStatus>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // SMARC_MSGS__MSG__DETAIL__SENSOR_STATUS__TRAITS_HPP_
