...
bool sam_msgs__msg__leak__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sam_msgs.msg._leak.Leak", full_classname_dest, 23) == 0);
  }
  sam_msgs__msg__Leak * ros_message = _ros_message;
  {  // value
...
PyObject * sam_msgs__msg__leak__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sam_msgs.msg._leak");
