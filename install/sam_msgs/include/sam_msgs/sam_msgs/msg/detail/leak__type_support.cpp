...
{
  new (message_memory) sam_msgs::msg::Leak(_init);
}

void Leak_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sam_msgs::msg::Leak *>(message_memory);
  typed_message->~Leak();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Leak_message_member_array[2] = {
  {
    ...
    offsetof(sam_msgs::msg::Leak, value),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sam_msgs::msg::Leak, leak_counter),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::sam_msgs::msg::rosidl_typesupport_introspection_cpp::Leak_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sam_msgs, msg, Leak)() {
  return &::sam_msgs::msg::rosidl_typesupport_introspection_cpp::Leak_message_type_support_handle;
}
