...
sam_msgs__msg__LightCommandArray__init(sam_msgs__msg__LightCommandArray * msg)
{
  ...
  // array
  if (!sam_msgs__msg__LightCommand__Sequence__init(&msg->array, 0)) {
    sam_msgs__msg__LightCommandArray__fini(msg);
    return false;
  }
  return true;
}
...
sam_msgs__msg__LightCommandArray__fini(sam_msgs__msg__LightCommandArray * msg)
{
  ...
  // array
  sam_msgs__msg__LightCommand__Sequence__fini(&msg->array);
}
...
sam_msgs__msg__LightCommandArray__are_equal(const sam_msgs__msg__LightCommandArray * lhs, const sam_msgs__msg__LightCommandArray * rhs)
{
  ...
  // array
  if (!sam_msgs__msg__LightCommand__Sequence__are_equal(
      &(lhs->array), &(rhs->array)))
  {
    return false;
  }
  ...
  sam_msgs__msg__LightCommandArray * output)
{
  ...
  // array
  if (!sam_msgs__msg__LightCommand__Sequence__copy(
...
sam_msgs__msg__LightCommandArray__create()
{
  ...
  sam_msgs__msg__LightCommandArray * msg = (sam_msgs__msg__LightCommandArray *)allocator.allocate(sizeof(sam_msgs__msg__LightCommandArray), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sam_msgs__msg__LightCommandArray));
  bool success = sam_msgs__msg__LightCommandArray__init(msg);
  if (!success) {
...
sam_msgs__msg__LightCommandArray__Sequence__init(sam_msgs__msg__LightCommandArray__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sam_msgs__msg__LightCommandArray * data = NULL;

  if (size) {
    data = (sam_msgs__msg__LightCommandArray *)allocator.zero_allocate(size, sizeof(sam_msgs__msg__LightCommandArray), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sam_msgs__msg__LightCommandArray__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        sam_msgs__msg__LightCommandArray__fini(&data[i - 1]);
      }
...
sam_msgs__msg__LightCommandArray__Sequence__fini(sam_msgs__msg__LightCommandArray__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      sam_msgs__msg__LightCommandArray__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sam_msgs__msg__LightCommandArray__Sequence * array = (sam_msgs__msg__LightCommandArray__Sequence *)allocator.allocate(sizeof(sam_msgs__msg__LightCommandArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sam_msgs__msg__LightCommandArray__Sequence__init(array, size);
  if (!success) {
...
sam_msgs__msg__LightCommandArray__Sequence__destroy(sam_msgs__msg__LightCommandArray__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sam_msgs__msg__LightCommandArray__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
sam_msgs__msg__LightCommandArray__Sequence__are_equal(const sam_msgs__msg__LightCommandArray__Sequence * lhs, const sam_msgs__msg__LightCommandArray__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sam_msgs__msg__LightCommandArray__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  sam_msgs__msg__LightCommandArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sam_msgs__msg__LightCommandArray);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sam_msgs__msg__LightCommandArray * data =
      (sam_msgs__msg__LightCommandArray *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sam_msgs__msg__LightCommandArray__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sam_msgs__msg__LightCommandArray__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!sam_msgs__msg__LightCommandArray__copy(
