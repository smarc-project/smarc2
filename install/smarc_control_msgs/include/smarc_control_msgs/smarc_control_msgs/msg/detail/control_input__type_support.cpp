...
{
  new (message_memory) smarc_control_msgs::msg::ControlInput(_init);
}

void ControlInput_fini_function(void * message_memory)
{
  auto typed_message = static_cast<smarc_control_msgs::msg::ControlInput *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ControlInput_message_member_array[5] = {
  {
    ...
    offsetof(smarc_control_msgs::msg::ControlInput, thrusterrpm),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(smarc_control_msgs::msg::ControlInput, thrustervertical),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(smarc_control_msgs::msg::ControlInput, thrusterhorizontal),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(smarc_control_msgs::msg::ControlInput, vbs),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(smarc_control_msgs::msg::ControlInput, lcg),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ControlInput_message_members = {
  ...
  5,  // number of fields
  sizeof(smarc_control_msgs::msg::ControlInput),
...
{
  return &::smarc_control_msgs::msg::rosidl_typesupport_introspection_cpp::ControlInput_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, smarc_control_msgs, msg, ControlInput)() {
  return &::smarc_control_msgs::msg::rosidl_typesupport_introspection_cpp::ControlInput_message_type_support_handle;
}
