...
bool smarc_control_msgs__msg__control_error__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("smarc_control_msgs.msg._control_error.ControlError", full_classname_dest, 50) == 0);
  }
  smarc_control_msgs__msg__ControlError * ros_message = _ros_message;
  {  // x
...
PyObject * smarc_control_msgs__msg__control_error__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("smarc_control_msgs.msg._control_error");
