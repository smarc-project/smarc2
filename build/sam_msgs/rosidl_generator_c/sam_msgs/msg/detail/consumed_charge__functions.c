...
sam_msgs__msg__ConsumedCharge__init(sam_msgs__msg__ConsumedCharge * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    sam_msgs__msg__ConsumedCharge__fini(msg);
    return false;
  }
  // circuit_id
  // charge
...
sam_msgs__msg__ConsumedCharge__create()
{
  ...
  sam_msgs__msg__ConsumedCharge * msg = (sam_msgs__msg__ConsumedCharge *)allocator.allocate(sizeof(sam_msgs__msg__ConsumedCharge), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sam_msgs__msg__ConsumedCharge));
  bool success = sam_msgs__msg__ConsumedCharge__init(msg);
  if (!success) {
...
sam_msgs__msg__ConsumedCharge__Sequence__init(sam_msgs__msg__ConsumedCharge__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sam_msgs__msg__ConsumedCharge * data = NULL;

  if (size) {
    data = (sam_msgs__msg__ConsumedCharge *)allocator.zero_allocate(size, sizeof(sam_msgs__msg__ConsumedCharge), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sam_msgs__msg__ConsumedCharge__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        sam_msgs__msg__ConsumedCharge__fini(&data[i - 1]);
      }
...
sam_msgs__msg__ConsumedCharge__Sequence__fini(sam_msgs__msg__ConsumedCharge__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      sam_msgs__msg__ConsumedCharge__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sam_msgs__msg__ConsumedCharge__Sequence * array = (sam_msgs__msg__ConsumedCharge__Sequence *)allocator.allocate(sizeof(sam_msgs__msg__ConsumedCharge__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sam_msgs__msg__ConsumedCharge__Sequence__init(array, size);
  if (!success) {
...
sam_msgs__msg__ConsumedCharge__Sequence__destroy(sam_msgs__msg__ConsumedCharge__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sam_msgs__msg__ConsumedCharge__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
sam_msgs__msg__ConsumedCharge__Sequence__are_equal(const sam_msgs__msg__ConsumedCharge__Sequence * lhs, const sam_msgs__msg__ConsumedCharge__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sam_msgs__msg__ConsumedCharge__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  sam_msgs__msg__ConsumedCharge__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sam_msgs__msg__ConsumedCharge);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sam_msgs__msg__ConsumedCharge * data =
      (sam_msgs__msg__ConsumedCharge *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sam_msgs__msg__ConsumedCharge__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sam_msgs__msg__ConsumedCharge__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!sam_msgs__msg__ConsumedCharge__copy(
