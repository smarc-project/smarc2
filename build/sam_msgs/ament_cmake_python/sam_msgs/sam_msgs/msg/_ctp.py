...
class Metaclass_CTP(type):
    """Metaclass of message 'CTP'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__ctp
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__ctp
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__ctp
            cls._TYPE_SUPPORT = module.type_support_msg__msg__ctp
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__ctp
...
class CTP(metaclass=Metaclass_CTP):
    """Message class 'CTP'."""
    ...
    def conductivity(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'conductivity' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
