...
static const _CircuitStatusStamped_type_support_symbol_names_t _CircuitStatusStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sam_msgs, msg, CircuitStatusStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sam_msgs, msg, CircuitStatusStamped)),
  }
};
...
{
  return &::sam_msgs::msg::rosidl_typesupport_cpp::CircuitStatusStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sam_msgs, msg, CircuitStatusStamped)() {
  return get_message_type_support_handle<sam_msgs::msg::CircuitStatusStamped>();
}
