...
#include "sam_msgs/msg/detail/leak__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sam_msgs::msg::Leak & ros_message,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sam_msgs::msg::Leak;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sam_msgs::msg::Leak *>(
    untyped_ros_message);
...
{
  return &sam_msgs::msg::typesupport_fastrtps_cpp::_Leak__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sam_msgs, msg, Leak)() {
  return &sam_msgs::msg::typesupport_fastrtps_cpp::_Leak__handle;
}
