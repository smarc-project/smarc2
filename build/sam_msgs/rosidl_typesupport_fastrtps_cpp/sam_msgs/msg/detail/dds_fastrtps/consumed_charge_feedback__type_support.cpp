...
#include "sam_msgs/msg/detail/consumed_charge_feedback__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sam_msgs::msg::ConsumedChargeFeedback & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sam_msgs::msg::ConsumedChargeFeedback & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sam_msgs
max_serialized_size_ConsumedChargeFeedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sam_msgs::msg::ConsumedChargeFeedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sam_msgs::msg::ConsumedChargeFeedback *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sam_msgs::msg::ConsumedChargeFeedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ConsumedChargeFeedback__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const sam_msgs::msg::ConsumedChargeFeedback *>(
...
static size_t _ConsumedChargeFeedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ConsumedChargeFeedback(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ConsumedChargeFeedback__callbacks = {
  "sam_msgs::msg",
...
static rosidl_message_type_support_t _ConsumedChargeFeedback__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ConsumedChargeFeedback__callbacks,
...
{
  return &sam_msgs::msg::typesupport_fastrtps_cpp::_ConsumedChargeFeedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sam_msgs, msg, ConsumedChargeFeedback)() {
  return &sam_msgs::msg::typesupport_fastrtps_cpp::_ConsumedChargeFeedback__handle;
}
