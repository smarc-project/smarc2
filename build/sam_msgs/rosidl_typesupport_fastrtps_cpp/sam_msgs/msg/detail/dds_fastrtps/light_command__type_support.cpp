...
#include "sam_msgs/msg/detail/light_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sam_msgs::msg::LightCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sam_msgs::msg::LightCommand & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sam_msgs::msg::LightCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sam_msgs::msg::LightCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sam_msgs::msg::LightCommand *>(
    untyped_ros_message);
...
{
  return &sam_msgs::msg::typesupport_fastrtps_cpp::_LightCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sam_msgs, msg, LightCommand)() {
  return &sam_msgs::msg::typesupport_fastrtps_cpp::_LightCommand__handle;
}
