...
#include "sam_msgs/msg/detail/command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sam_msgs::msg::Command & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sam_msgs::msg::Command & ros_message)
{
  // Member: actuator_id
  cdr >> ros_message.actuator_id;
  ...
  size_t current_alignment)
{
  ...
  // Member: command_value
  {
    size_t item_size = sizeof(ros_message.command_value);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sam_msgs::msg::Command;
    is_plain =
      (
      offsetof(DataType, command_value) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const sam_msgs::msg::Command *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sam_msgs::msg::Command *>(
    untyped_ros_message);
...
{
  return &sam_msgs::msg::typesupport_fastrtps_cpp::_Command__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sam_msgs, msg, Command)() {
  return &sam_msgs::msg::typesupport_fastrtps_cpp::_Command__handle;
}
