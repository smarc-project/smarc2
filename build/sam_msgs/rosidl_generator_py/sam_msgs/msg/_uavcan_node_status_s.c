...
bool sam_msgs__msg__uavcan_node_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sam_msgs.msg._uavcan_node_status.UavcanNodeStatus", full_classname_dest, 49) == 0);
  }
  sam_msgs__msg__UavcanNodeStatus * ros_message = _ros_message;
  {  // uptime_sec
...
{
  /* NOTE(esteve): Call constructor of UavcanNodeStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sam_msgs.msg._uavcan_node_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UavcanNodeStatus");
