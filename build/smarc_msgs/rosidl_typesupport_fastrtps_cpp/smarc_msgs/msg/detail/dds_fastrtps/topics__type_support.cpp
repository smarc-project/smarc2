...
#include "smarc_msgs/msg/detail/topics__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smarc_msgs::msg::Topics;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smarc_msgs::msg::Topics *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<smarc_msgs::msg::Topics *>(
    untyped_ros_message);
...
{
  return &smarc_msgs::msg::typesupport_fastrtps_cpp::_Topics__handle;
}
