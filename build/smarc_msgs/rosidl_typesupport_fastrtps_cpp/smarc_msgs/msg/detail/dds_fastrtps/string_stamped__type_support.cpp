...
#include "smarc_msgs/msg/detail/string_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const smarc_msgs::msg::StringStamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  smarc_msgs::msg::StringStamped & ros_message)
{
  // Member: time_sent
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smarc_msgs::msg::StringStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smarc_msgs::msg::StringStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<smarc_msgs::msg::StringStamped *>(
    untyped_ros_message);
...
{
  return &smarc_msgs::msg::typesupport_fastrtps_cpp::_StringStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smarc_msgs, msg, StringStamped)() {
  return &smarc_msgs::msg::typesupport_fastrtps_cpp::_StringStamped__handle;
}
