...
#include "smarc_msgs/msg/detail/float_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const smarc_msgs::msg::FloatStamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  smarc_msgs::msg::FloatStamped & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smarc_msgs::msg::FloatStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smarc_msgs::msg::FloatStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<smarc_msgs::msg::FloatStamped *>(
    untyped_ros_message);
...
{
  return &smarc_msgs::msg::typesupport_fastrtps_cpp::_FloatStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smarc_msgs, msg, FloatStamped)() {
  return &smarc_msgs::msg::typesupport_fastrtps_cpp::_FloatStamped__handle;
}
