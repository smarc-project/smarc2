...
#include "smarc_msgs/msg/detail/controller_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const smarc_msgs::msg::ControllerStatus & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.diagnostics_message;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  smarc_msgs::msg::ControllerStatus & ros_message)
{
  // Member: control_status
  cdr >> ros_message.control_status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smarc_msgs::msg::ControllerStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smarc_msgs::msg::ControllerStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<smarc_msgs::msg::ControllerStatus *>(
    untyped_ros_message);
...
{
  return &smarc_msgs::msg::typesupport_fastrtps_cpp::_ControllerStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smarc_msgs, msg, ControllerStatus)() {
  return &smarc_msgs::msg::typesupport_fastrtps_cpp::_ControllerStatus__handle;
}
