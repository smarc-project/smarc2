...
#include "smarc_msgs/msg/detail/sensor_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smarc_msgs::msg::SensorStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smarc_msgs::msg::SensorStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<smarc_msgs::msg::SensorStatus *>(
    untyped_ros_message);
...
{
  return &smarc_msgs::msg::typesupport_fastrtps_cpp::_SensorStatus__handle;
}
