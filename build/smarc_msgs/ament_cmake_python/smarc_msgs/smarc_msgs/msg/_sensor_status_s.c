...
bool smarc_msgs__msg__sensor_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("smarc_msgs.msg._sensor_status.SensorStatus", full_classname_dest, 42) == 0);
  }
  smarc_msgs__msg__SensorStatus * ros_message = _ros_message;
  {  // sensor_status
...
PyObject * smarc_msgs__msg__sensor_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("smarc_msgs.msg._sensor_status");
