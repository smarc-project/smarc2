...
static const _LatLonOdometry_type_support_symbol_names_t _LatLonOdometry_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smarc_msgs, msg, LatLonOdometry)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, smarc_msgs, msg, LatLonOdometry)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, smarc_msgs, msg, LatLonOdometry)() {
  return &::smarc_msgs::msg::rosidl_typesupport_c::LatLonOdometry_message_type_support_handle;
}
