...
static const _ControllerStatus_type_support_symbol_names_t _ControllerStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smarc_msgs, msg, ControllerStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, smarc_msgs, msg, ControllerStatus)),
  }
};
...
{
  return &::smarc_msgs::msg::rosidl_typesupport_cpp::ControllerStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, smarc_msgs, msg, ControllerStatus)() {
  return get_message_type_support_handle<smarc_msgs::msg::ControllerStatus>();
}
