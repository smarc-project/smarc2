...
static const _AddTasks_Request_type_support_symbol_names_t _AddTasks_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smarc_msgs, srv, AddTasks_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, smarc_msgs, srv, AddTasks_Request)),
  }
};
...
{
  return &::smarc_msgs::srv::rosidl_typesupport_cpp::AddTasks_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, smarc_msgs, srv, AddTasks_Request)() {
  return get_message_type_support_handle<smarc_msgs::srv::AddTasks_Request>();
}
...
static const _AddTasks_Response_type_support_symbol_names_t _AddTasks_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smarc_msgs, srv, AddTasks_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, smarc_msgs, srv, AddTasks_Response)),
  }
};
...
{
  return &::smarc_msgs::srv::rosidl_typesupport_cpp::AddTasks_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, smarc_msgs, srv, AddTasks_Response)() {
  return get_message_type_support_handle<smarc_msgs::srv::AddTasks_Response>();
}
...
static const _AddTasks_type_support_symbol_names_t _AddTasks_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smarc_msgs, srv, AddTasks)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, smarc_msgs, srv, AddTasks)),
  }
};
...
{
  return &::smarc_msgs::srv::rosidl_typesupport_cpp::AddTasks_service_type_support_handle;
}
