...
class CommsMessage(metaclass=Metaclass_CommsMessage):
    ...
    def __init__(self, **kwargs):
        ...
        self.source_ns = kwargs.get('source_ns', str())
        self.target_ns = kwargs.get('target_ns', str())
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.source_ns != other.source_ns:
            return False
        if self.target_ns != other.target_ns:
            return False
    ...
    @builtins.property
    def source_ns(self):
        """Message field 'source_ns'."""
        return self._source_ns

    @source_ns.setter
    def source_ns(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'source_ns' field must be of type 'str'"
        self._source_ns = value

    @builtins.property
    def target_ns(self):
        """Message field 'target_ns'."""
        return self._target_ns

    @target_ns.setter
    def target_ns(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'target_ns' field must be of type 'str'"
        self._target_ns = value
