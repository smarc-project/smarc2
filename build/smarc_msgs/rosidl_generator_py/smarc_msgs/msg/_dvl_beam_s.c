...
bool smarc_msgs__msg__dvl_beam__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("smarc_msgs.msg._dvl_beam.DVLBeam", full_classname_dest, 32) == 0);
  }
  smarc_msgs__msg__DVLBeam * ros_message = _ros_message;
  {  // range
  ...
  {  // range_covariance
    PyObject * field = PyObject_GetAttrString(_pymsg, "range_covariance");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->range_covariance = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // velocity
  ...
  {  // velocity_covariance
    ...
    assert(PyFloat_Check(field));
    ros_message->velocity_covariance = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // pose
...
PyObject * smarc_msgs__msg__dvl_beam__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("smarc_msgs.msg._dvl_beam");
  ...
  {  // range_covariance
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->range_covariance);
    {
      int rc = PyObject_SetAttrString(_pymessage, "range_covariance", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // velocity_covariance
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->velocity_covariance);
    {
      int rc = PyObject_SetAttrString(_pymessage, "velocity_covariance", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
