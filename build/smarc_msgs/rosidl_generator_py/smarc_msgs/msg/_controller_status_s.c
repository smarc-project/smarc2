...
bool smarc_msgs__msg__controller_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("smarc_msgs.msg._controller_status.ControllerStatus", full_classname_dest, 50) == 0);
  }
  smarc_msgs__msg__ControllerStatus * ros_message = _ros_message;
  {  // control_status
  ...
  {  // diagnostics_message
    PyObject * field = PyObject_GetAttrString(_pymsg, "diagnostics_message");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->diagnostics_message, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
...
PyObject * smarc_msgs__msg__controller_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("smarc_msgs.msg._controller_status");
  ...
  {  // diagnostics_message
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->diagnostics_message.data,
      strlen(ros_message->diagnostics_message.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "diagnostics_message", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
