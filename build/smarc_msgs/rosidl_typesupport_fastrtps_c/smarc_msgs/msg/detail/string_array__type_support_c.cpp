...
#include "smarc_msgs/msg/detail/string_array__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // string_array
#include "rosidl_runtime_c/string_functions.h"  // string_array

// forward declare type support functions


using _StringArray__ros_msg_type = smarc_msgs__msg__StringArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = ros_message->string_array.size;
    auto array_ptr = ros_message->string_array.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: string_array
  {
    ...
    if (ros_message->string_array.data) {
      rosidl_runtime_c__String__Sequence__fini(&ros_message->string_array);
    }
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->string_array, size)) {
      fprintf(stderr, "failed to create array for field 'string_array'");
      return false;
    }
    auto array_ptr = ros_message->string_array.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_smarc_msgs__msg__StringArray(
  const void * untyped_ros_message,
...
static uint32_t _StringArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_smarc_msgs__msg__StringArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smarc_msgs
size_t max_serialized_size_smarc_msgs__msg__StringArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smarc_msgs__msg__StringArray;
    is_plain =
      (
...
static size_t _StringArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smarc_msgs__msg__StringArray(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smarc_msgs, msg, StringArray)() {
