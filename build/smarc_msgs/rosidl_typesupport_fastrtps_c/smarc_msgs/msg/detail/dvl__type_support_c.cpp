...
#include "smarc_msgs/msg/detail/dvl__rosidl_typesupport_fastrtps_c.h"
...
#include "smarc_msgs/msg/detail/dvl_beam__functions.h"  // beams
...
size_t get_serialized_size_smarc_msgs__msg__DVLBeam(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_smarc_msgs__msg__DVLBeam(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smarc_msgs, msg, DVLBeam)();
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_smarc_msgs
...
using _DVL__ros_msg_type = smarc_msgs__msg__DVL;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: beams
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, smarc_msgs, msg, DVLBeam
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: beams
  {
    ...
    if (ros_message->beams.data) {
      smarc_msgs__msg__DVLBeam__Sequence__fini(&ros_message->beams);
    }
...
size_t get_serialized_size_smarc_msgs__msg__DVL(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DVL__ros_msg_type * ros_message = static_cast<const _DVL__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name beams
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_smarc_msgs__msg__DVLBeam(
...
static uint32_t _DVL__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_smarc_msgs__msg__DVL(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smarc_msgs
size_t max_serialized_size_smarc_msgs__msg__DVL(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: beams
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_smarc_msgs__msg__DVLBeam(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = smarc_msgs__msg__DVL;
    is_plain =
      (
...
static size_t _DVL__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smarc_msgs__msg__DVL(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smarc_msgs, msg, DVL)() {
