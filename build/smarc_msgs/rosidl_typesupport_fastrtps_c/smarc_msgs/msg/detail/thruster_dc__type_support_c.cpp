...
#include "smarc_msgs/msg/detail/thruster_dc__rosidl_typesupport_fastrtps_c.h"
...
using _ThrusterDC__ros_msg_type = smarc_msgs__msg__ThrusterDC;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ThrusterDC__ros_msg_type * ros_message = static_cast<const _ThrusterDC__ros_msg_type *>(untyped_ros_message);
  // Field name: dc
  {
    cdr << ros_message->dc;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _ThrusterDC__ros_msg_type * ros_message = static_cast<_ThrusterDC__ros_msg_type *>(untyped_ros_message);
  // Field name: dc
  {
    cdr >> ros_message->dc;
  }
...
static uint32_t _ThrusterDC__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_smarc_msgs__msg__ThrusterDC(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smarc_msgs__msg__ThrusterDC;
    is_plain =
      (
...
static size_t _ThrusterDC__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smarc_msgs__msg__ThrusterDC(
...
static message_type_support_callbacks_t __callbacks_ThrusterDC = {
  "smarc_msgs::msg",
  "ThrusterDC",
