...
#include "smarc_msgs/msg/detail/thruster_rpm__rosidl_typesupport_fastrtps_c.h"
...
using _ThrusterRPM__ros_msg_type = smarc_msgs__msg__ThrusterRPM;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ThrusterRPM__ros_msg_type * ros_message = static_cast<const _ThrusterRPM__ros_msg_type *>(untyped_ros_message);
  // Field name: rpm
  {
    cdr << ros_message->rpm;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _ThrusterRPM__ros_msg_type * ros_message = static_cast<_ThrusterRPM__ros_msg_type *>(untyped_ros_message);
  // Field name: rpm
  {
    cdr >> ros_message->rpm;
  }
...
static uint32_t _ThrusterRPM__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_smarc_msgs__msg__ThrusterRPM(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smarc_msgs__msg__ThrusterRPM;
    is_plain =
      (
...
static size_t _ThrusterRPM__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smarc_msgs__msg__ThrusterRPM(
...
static message_type_support_callbacks_t __callbacks_ThrusterRPM = {
  "smarc_msgs::msg",
  "ThrusterRPM",
