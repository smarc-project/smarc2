...
#include "smarc_msgs/msg/detail/leak__rosidl_typesupport_fastrtps_c.h"
...
using _Leak__ros_msg_type = smarc_msgs__msg__Leak;
...
size_t get_serialized_size_smarc_msgs__msg__Leak(
  const void * untyped_ros_message,
...
static uint32_t _Leak__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_smarc_msgs__msg__Leak(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smarc_msgs
size_t max_serialized_size_smarc_msgs__msg__Leak(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smarc_msgs__msg__Leak;
    is_plain =
      (
...
static size_t _Leak__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smarc_msgs__msg__Leak(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smarc_msgs, msg, Leak)() {
