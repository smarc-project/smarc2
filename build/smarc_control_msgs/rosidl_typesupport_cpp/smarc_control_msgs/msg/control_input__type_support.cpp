...
static const _ControlInput_type_support_symbol_names_t _ControlInput_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smarc_control_msgs, msg, ControlInput)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, smarc_control_msgs, msg, ControlInput)),
  }
};
...
{
  return &::smarc_control_msgs::msg::rosidl_typesupport_cpp::ControlInput_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, smarc_control_msgs, msg, ControlInput)() {
  return get_message_type_support_handle<smarc_control_msgs::msg::ControlInput>();
}
