...
static const _ControlInput_type_support_symbol_names_t _ControlInput_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smarc_control_msgs, msg, ControlInput)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, smarc_control_msgs, msg, ControlInput)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, smarc_control_msgs, msg, ControlInput)() {
  return &::smarc_control_msgs::msg::rosidl_typesupport_c::ControlInput_message_type_support_handle;
}
