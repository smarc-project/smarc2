...
#include "smarc_control_msgs/msg/detail/control_input__rosidl_typesupport_fastrtps_c.h"
...
using _ControlInput__ros_msg_type = smarc_control_msgs__msg__ControlInput;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: thrusterrpm
  {
    cdr << ros_message->thrusterrpm;
  }

  // Field name: thrustervertical
  {
    cdr << ros_message->thrustervertical;
  }

  // Field name: thrusterhorizontal
  {
...
size_t get_serialized_size_smarc_control_msgs__msg__ControlInput(
  const void * untyped_ros_message,
...
static uint32_t _ControlInput__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_smarc_control_msgs__msg__ControlInput(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smarc_control_msgs
size_t max_serialized_size_smarc_control_msgs__msg__ControlInput(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smarc_control_msgs__msg__ControlInput;
    is_plain =
      (
...
static size_t _ControlInput__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smarc_control_msgs__msg__ControlInput(
...
static message_type_support_callbacks_t __callbacks_ControlInput = {
...
static rosidl_message_type_support_t _ControlInput__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ControlInput,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smarc_control_msgs, msg, ControlInput)() {
  return &_ControlInput__type_support;
}
