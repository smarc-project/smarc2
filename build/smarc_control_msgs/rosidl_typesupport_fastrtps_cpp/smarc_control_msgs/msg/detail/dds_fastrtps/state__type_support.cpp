...
#include "smarc_control_msgs/msg/detail/state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const smarc_control_msgs::msg::State & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  smarc_control_msgs::msg::State & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smarc_control_msgs::msg::State;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smarc_control_msgs::msg::State *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<smarc_control_msgs::msg::State *>(
    untyped_ros_message);
...
{
  return &smarc_control_msgs::msg::typesupport_fastrtps_cpp::_State__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smarc_control_msgs, msg, State)() {
  return &smarc_control_msgs::msg::typesupport_fastrtps_cpp::_State__handle;
}
