...
#include "smarc_mission_msgs/msg/detail/topics__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const smarc_mission_msgs::msg::Topics & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  smarc_mission_msgs::msg::Topics & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smarc_mission_msgs::msg::Topics;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smarc_mission_msgs::msg::Topics *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<smarc_mission_msgs::msg::Topics *>(
    untyped_ros_message);
...
{
  return &smarc_mission_msgs::msg::typesupport_fastrtps_cpp::_Topics__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smarc_mission_msgs, msg, Topics)() {
  return &smarc_mission_msgs::msg::typesupport_fastrtps_cpp::_Topics__handle;
}
