...
smarc_mission_msgs__srv__UTMLatLon_Request__init(smarc_mission_msgs__srv__UTMLatLon_Request * msg)
{
  ...
  // utm_points
  if (!geometry_msgs__msg__PointStamped__Sequence__init(&msg->utm_points, 0)) {
    smarc_mission_msgs__srv__UTMLatLon_Request__fini(msg);
    return false;
  }
  // lat_lon_points
  if (!geographic_msgs__msg__GeoPoint__Sequence__init(&msg->lat_lon_points, 0)) {
    smarc_mission_msgs__srv__UTMLatLon_Request__fini(msg);
    return false;
  }
  return true;
...
smarc_mission_msgs__srv__UTMLatLon_Request__fini(smarc_mission_msgs__srv__UTMLatLon_Request * msg)
{
  ...
  // utm_points
  geometry_msgs__msg__PointStamped__Sequence__fini(&msg->utm_points);
  // lat_lon_points
  geographic_msgs__msg__GeoPoint__Sequence__fini(&msg->lat_lon_points);
}
...
smarc_mission_msgs__srv__UTMLatLon_Request__are_equal(const smarc_mission_msgs__srv__UTMLatLon_Request * lhs, const smarc_mission_msgs__srv__UTMLatLon_Request * rhs)
{
  ...
  if (!geometry_msgs__msg__PointStamped__Sequence__are_equal(
      &(lhs->utm_points), &(rhs->utm_points)))
  {
    return false;
  }
  // lat_lon_points
  if (!geographic_msgs__msg__GeoPoint__Sequence__are_equal(
      &(lhs->lat_lon_points), &(rhs->lat_lon_points)))
  {
    return false;
  }
  return true;
  ...
  smarc_mission_msgs__srv__UTMLatLon_Request * output)
{
  ...
  if (!geometry_msgs__msg__PointStamped__Sequence__copy(
      &(input->utm_points), &(output->utm_points)))
  {
    return false;
  }
  // lat_lon_points
  if (!geographic_msgs__msg__GeoPoint__Sequence__copy(
      &(input->lat_lon_points), &(output->lat_lon_points)))
  {
    return false;
  }
  return true;
...
smarc_mission_msgs__srv__UTMLatLon_Request__create()
{
  ...
  smarc_mission_msgs__srv__UTMLatLon_Request * msg = (smarc_mission_msgs__srv__UTMLatLon_Request *)allocator.allocate(sizeof(smarc_mission_msgs__srv__UTMLatLon_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(smarc_mission_msgs__srv__UTMLatLon_Request));
  bool success = smarc_mission_msgs__srv__UTMLatLon_Request__init(msg);
  if (!success) {
...
smarc_mission_msgs__srv__UTMLatLon_Request__Sequence__init(smarc_mission_msgs__srv__UTMLatLon_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smarc_mission_msgs__srv__UTMLatLon_Request * data = NULL;

  if (size) {
    data = (smarc_mission_msgs__srv__UTMLatLon_Request *)allocator.zero_allocate(size, sizeof(smarc_mission_msgs__srv__UTMLatLon_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = smarc_mission_msgs__srv__UTMLatLon_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        smarc_mission_msgs__srv__UTMLatLon_Request__fini(&data[i - 1]);
      }
...
smarc_mission_msgs__srv__UTMLatLon_Request__Sequence__fini(smarc_mission_msgs__srv__UTMLatLon_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      smarc_mission_msgs__srv__UTMLatLon_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smarc_mission_msgs__srv__UTMLatLon_Request__Sequence * array = (smarc_mission_msgs__srv__UTMLatLon_Request__Sequence *)allocator.allocate(sizeof(smarc_mission_msgs__srv__UTMLatLon_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = smarc_mission_msgs__srv__UTMLatLon_Request__Sequence__init(array, size);
  if (!success) {
...
smarc_mission_msgs__srv__UTMLatLon_Request__Sequence__destroy(smarc_mission_msgs__srv__UTMLatLon_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    smarc_mission_msgs__srv__UTMLatLon_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
smarc_mission_msgs__srv__UTMLatLon_Request__Sequence__are_equal(const smarc_mission_msgs__srv__UTMLatLon_Request__Sequence * lhs, const smarc_mission_msgs__srv__UTMLatLon_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!smarc_mission_msgs__srv__UTMLatLon_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  smarc_mission_msgs__srv__UTMLatLon_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(smarc_mission_msgs__srv__UTMLatLon_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    smarc_mission_msgs__srv__UTMLatLon_Request * data =
      (smarc_mission_msgs__srv__UTMLatLon_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!smarc_mission_msgs__srv__UTMLatLon_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          smarc_mission_msgs__srv__UTMLatLon_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!smarc_mission_msgs__srv__UTMLatLon_Request__copy(
...
smarc_mission_msgs__srv__UTMLatLon_Response__init(smarc_mission_msgs__srv__UTMLatLon_Response * msg)
{
  ...
  // lat_lon_points
  if (!geographic_msgs__msg__GeoPoint__Sequence__init(&msg->lat_lon_points, 0)) {
    smarc_mission_msgs__srv__UTMLatLon_Response__fini(msg);
    return false;
  }
  // utm_points
  if (!geometry_msgs__msg__PointStamped__Sequence__init(&msg->utm_points, 0)) {
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smarc_mission_msgs__srv__UTMLatLon_Response * msg = (smarc_mission_msgs__srv__UTMLatLon_Response *)allocator.allocate(sizeof(smarc_mission_msgs__srv__UTMLatLon_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(smarc_mission_msgs__srv__UTMLatLon_Response));
  bool success = smarc_mission_msgs__srv__UTMLatLon_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
smarc_mission_msgs__srv__UTMLatLon_Response__Sequence__init(smarc_mission_msgs__srv__UTMLatLon_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smarc_mission_msgs__srv__UTMLatLon_Response * data = NULL;

  if (size) {
    data = (smarc_mission_msgs__srv__UTMLatLon_Response *)allocator.zero_allocate(size, sizeof(smarc_mission_msgs__srv__UTMLatLon_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = smarc_mission_msgs__srv__UTMLatLon_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        smarc_mission_msgs__srv__UTMLatLon_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
smarc_mission_msgs__srv__UTMLatLon_Response__Sequence__fini(smarc_mission_msgs__srv__UTMLatLon_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      smarc_mission_msgs__srv__UTMLatLon_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  smarc_mission_msgs__srv__UTMLatLon_Response__Sequence * array = (smarc_mission_msgs__srv__UTMLatLon_Response__Sequence *)allocator.allocate(sizeof(smarc_mission_msgs__srv__UTMLatLon_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = smarc_mission_msgs__srv__UTMLatLon_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
smarc_mission_msgs__srv__UTMLatLon_Response__Sequence__destroy(smarc_mission_msgs__srv__UTMLatLon_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    smarc_mission_msgs__srv__UTMLatLon_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
smarc_mission_msgs__srv__UTMLatLon_Response__Sequence__are_equal(const smarc_mission_msgs__srv__UTMLatLon_Response__Sequence * lhs, const smarc_mission_msgs__srv__UTMLatLon_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!smarc_mission_msgs__srv__UTMLatLon_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  smarc_mission_msgs__srv__UTMLatLon_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(smarc_mission_msgs__srv__UTMLatLon_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    smarc_mission_msgs__srv__UTMLatLon_Response * data =
      (smarc_mission_msgs__srv__UTMLatLon_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!smarc_mission_msgs__srv__UTMLatLon_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          smarc_mission_msgs__srv__UTMLatLon_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!smarc_mission_msgs__srv__UTMLatLon_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
