...
static const _GotoWaypoint_type_support_symbol_names_t _GotoWaypoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smarc_mission_msgs, msg, GotoWaypoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, smarc_mission_msgs, msg, GotoWaypoint)),
  }
};
...
{
  return &::smarc_mission_msgs::msg::rosidl_typesupport_cpp::GotoWaypoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, smarc_mission_msgs, msg, GotoWaypoint)() {
  return get_message_type_support_handle<smarc_mission_msgs::msg::GotoWaypoint>();
}
